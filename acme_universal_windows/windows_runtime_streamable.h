...
//
//   class CLASS_DECL_ACME_UNIVERSAL_WINDOWS streamable:
//      virtual public ::file::streamable
//   {
//   public:
//
//
//
//
//      internal_native_buffer();
//      internal_native_buffer(StorageFile ^ file);
//      virtual ~internal_native_buffer();
//
//
