...
//      stream_socket(h),
      ...
      ,m_buf(__allocate_array< char >(TCP_BUFSIZE_READ + 1))
#endif
      ,m_obuf_top(nullptr)
      ,m_transfer_limit(0)
      ,m_output_length(0)
...
#pragma warning(default:4355)
   ...
   bool tcp_socket::open(::networking::address * ad, ::networking::address * bind_ad, bool skip_socks)
   {
      ...
      ::winrt::Windows::Networking::EndpointPair ^ pair = ref allocateø< ::winrt::Windows::Networking::EndpointPair(bind_ad.m_hostname,  ansi_string_from_long_long(bind_ad.get_service_number()), ad.m_hostname, ansi_string_from_long_long(ad.get_service_number >()));
   ...
   bool tcp_socket::open(const ::scoped_string & scopedstrHost,port_t port)
   {
   ...
   void tcp_socket::OnRead()
   {
      ...
      //op->Completed =
      //ref allocateø< ::winrt::Windows::Foundation::AsyncOperationCompletedHandler < unsigned int > >([=]
   ...
   int tcp_socket::TryWrite(const_char_pointer buf, memsize len)
   {
      ...
      m_streamsocket->OutputStream->WriteAsync(m_bufferWrite)
         ->Completed = ref allocateø< ::winrt::Windows::Foundation::AsyncOperationWithProgressCompletedHandler <unsigned int, unsigned int >([this] >(::winrt::Windows::Foundation::IAsyncOperationWithProgress <unsigned int, unsigned int >^ operation, ::winrt::Windows::Foundation::AsyncStatus status)
            {
