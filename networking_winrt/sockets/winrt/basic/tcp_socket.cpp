...
//      stream_socket(h),
      ...
      ,m_buf(__new_array< char >(TCP_BUFSIZE_READ + 1))
#endif
      ,m_obuf_top(nullptr)
      ,m_transfer_limit(0)
      ,m_output_length(0)
...
#pragma warning(default:4355)
   ...
   void tcp_socket::OnRead()
   {
      ...
      //op->Completed =
      //ref __new< ::winrt::Windows::Foundation::AsyncOperationCompletedHandler < unsigned int > >([=]
   ...
   int tcp_socket::TryWrite(const char *buf, memsize len)
   {
      ...
      m_streamsocket->OutputStream->WriteAsync(m_bufferWrite)
         ->Completed = ref __new< ::winrt::Windows::Foundation::AsyncOperationWithProgressCompletedHandler <unsigned int, unsigned int >([this] >(::winrt::Windows::Foundation::IAsyncOperationWithProgress <unsigned int, unsigned int >^ operation, ::winrt::Windows::Foundation::AsyncStatus status)
            {
