...
/*            if (GetSocket() != INVALID_SOCKET)
      ...
      int Bind(::networking::address & ad, const string & protocol, int depth = 20)
      {
         ...
         m_tokenConnectionReceived = m_listener->ConnectionReceived += ref allocateø< ::winrt::Windows::Foundation::TypedEventHandler < ::winrt::Windows::Networking::Sockets::StreamSocketListener^, ::winrt::Windows::Networking::Sockets::StreamSocketListenerConnectionReceivedEventArgs^> >(m_bridge, &bridge::StreamSocketListener_ConnectionReceived);
...
/*            {
      ...
      void StreamSocketListener_ConnectionReceived(::winrt::Windows::Networking::Sockets::StreamSocketListener ^ listener, ::winrt::Windows::Networking::Sockets::StreamSocketListenerConnectionReceivedEventArgs ^ args)
      {
         ...
         else
         {
            ...
            pstreamsocket = allocateø< SOCKET_IMPL(socket_handler >());
