...
/*            if (GetSocket() != INVALID_SOCKET)
      ...
      int Bind(::networking::address & ad,int depth)
      {
      ...
      \param protocol Network protocol
      \param depth Listen queue depth */
      int Bind(::networking::address & ad, const string & protocol, int depth = 20)
      {
         ...
         m_tokenConnectionReceived = m_listener->ConnectionReceived += ref __new< ::winrt::Windows::Foundation::TypedEventHandler < ::winrt::Windows::Networking::Sockets::StreamSocketListener^, ::winrt::Windows::Networking::Sockets::StreamSocketListenerConnectionReceivedEventArgs^> >(m_bridge, &bridge::StreamSocketListener_ConnectionReceived);
...
/*            {
         ...
         //::sockets::socket::os_data data;
         //data.o = m_listener;
         //m_socket = ::apexacmesystem()->sockets().net().m_
         //attach(data);
         return 0;
      ...
      void StreamSocketListener_ConnectionReceived(::winrt::Windows::Networking::Sockets::StreamSocketListener ^ listener, ::winrt::Windows::Networking::Sockets::StreamSocketListenerConnectionReceivedEventArgs ^ args)
      {
         ...
         else
         {
            ...
            pstreamsocket = __new< SOCKET_IMPL(socket_handler >());
