...
namespace sockets
{
   ...
   ::networking::address stream_socket::GetRemoteAddress()
   {

      return ::networking::address(get_app(), m_streamsocket->Information->RemoteAddress->CanonicalName, m_streamsocket->Information->RemotePort);
   ...
   ::networking::address stream_socket::GetLocalAddress()
   {

      return ::networking::address(get_app(), m_streamsocket->Information->LocalAddress->CanonicalName, m_streamsocket->Information->LocalPort);
