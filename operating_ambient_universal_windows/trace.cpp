...
//   DEFINE_MESSAGE(::user::e_message_move),
...
//   DEFINE_MESSAGE(::user::e_message_non_client_calc_size),
//   DEFINE_MESSAGE(::user::e_message_non_client_hit_test),
...
void TraceDDE(const ::scoped_string & scopedstrPrefix, const MSG* pMsg)
