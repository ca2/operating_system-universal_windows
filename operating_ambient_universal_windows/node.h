...
#include "node_universal_windows/node.h"


namespace operating_ambient_universal_windows
{


   class CLASS_DECL_OPERATING_AMBIENT_UNIVERSAL_WINDOWS node :
      virtual public ::node_universal_windows::node
   {
   public:
