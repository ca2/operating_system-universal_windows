...
//BEGIN_FACTORY(operating_ambient_windows)
...
__FACTORY_IMPORT void node_universal_windows_factory(::factory::factory * pfactory);




__FACTORY_EXPORT void operating_ambient_universal_windows_factory(::factory::factory * pfactory)
{


   node_universal_windows_factory(pfactory);
   ...
   pfactory->add_factory_item < ::operating_ambient_universal_windows::node, ::platform::node >();
