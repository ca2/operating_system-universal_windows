...
namespace aura_universal_windows
{
   ...
   namespace hardware
   {
      ...
      //   ::pointer < class device_group > pdevicegroup = m_mapdevicegroup[edevice];

      //   pdevicegroup->__start();
      ...
      void devices::update_device_list(::hardware::enum_device edevice)
      {

         ::hardware::devices::update_device_list(edevice);
...
//   }
//
//   ::windows::g_pdevices = ___new ::windows::devices((HWND) psysteminteraction->m_pacmewindowingwindow);
//
