...
static void __post_init_dialog(::user::interaction * pWnd,const RECTANGLE_I32& rectOld,u32 dwStyleOld);
...
namespace universal_windows
{
   ...
   bool interaction_impl::_native_create_window_ex(__pointer(::user::system) pusersystem)
   {
      ...
      //   m_pwindowing->windowing_sync(15_s, __routine([this, pusersystem, x, y, cx, cy]()
      //      {
      ...
      //               m_applicationview.get().SetPreferredMinSize({ (float)cx, (float)cy });
      ...
      //            auto Id1 = applicationview1.get().Id();
      ...
      //               m_rectangle.left = (LONG) m_window.get().Bounds().X;
      //               m_rectangle.top = (LONG)m_window.get().Bounds().Y;
      //               m_rectangle.right = (LONG)(m_rectangle.left + m_window.get().Bounds().Width);
      //               m_rectangle.bottom = (LONG)(m_rectangle.top + m_window.get().Bounds().Height);
      ...
      //               m_applicationview.get().TryResizeView(::winrt::Windows::Foundation::Size({ (float)cx,(float)cy }));
      ...
      //send_message(e_message_create, 0, 0);
...
//         m_puserinteraction->get_application()->step_timer();
      ...
      *ppapp = get_application();
            ...
            pusermessage->m_id == e_message_mouse_wheel)
      {
         ...
         message::mouse * pmouse = (::message::mouse *) pusermessage->m_pmouse;
...
//   }
   ...
   //   //rectangle_i64 rectWindowOld = m_rectParentClient;
...
namespace universal_windows
{
   ...
   void interaction_impl::set_view_port_org(::image * pimage)
   {
      ...
      pimage->SetViewportOrg(point_i32(rectWindow.top_left()));
   ...
   bool interaction_impl::_is_window() const
   {
      ...
      //return m_pframeworkview != nullptr && m_pframeworkview.get().m_window != nullptr;
   ...
   void interaction_impl::set_input_content_rect(const rectangle_i32& rectangle)
   {
      ...
      //__copy(m_pframeworkview.get().m_rectInputContentRect, rectangle);
   ...
   void interaction_impl::set_input_selection_rect(const rectangle_i32& rectangle)
   {
      ...
      //__copy(m_pframeworkview.get().m_rectInputSelectionRect, rectangle);
   ...
   rectangle_i32 interaction_impl::get_input_content_rect()
   {
      ...
      //__copy(rectangle, m_pframeworkview.get().m_rectInputContentRect);
   ...
   rectangle_i32 interaction_impl::get_input_selection_rect()
   {
      ...
      //__copy(rectangle, m_pframeworkview.get().m_rectInputSelectionRect);
