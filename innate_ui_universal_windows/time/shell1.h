...
//      static HANDLE WINAPI _FindFirstFile(const unichar * pcsz, UNIVERSAL_WINDOWS_FIND_DATAW * pdata);
//
//      static BOOL WINAPI _FindNextFile(HANDLE handle, UNIVERSAL_WINDOWS_FIND_DATAW * pdata);
//
...
//      HANDLE (WINAPI * m_pfnFindFirstFile)(const unichar * pcsz, UNIVERSAL_WINDOWS_FIND_DATAW * pdata);
//
//      BOOL (WINAPI * m_pfnFindNextFile)(HANDLE handle, UNIVERSAL_WINDOWS_FIND_DATAW * pdata);
//
...
//      static HANDLE FindFirstFile(const unichar * pcsz, UNIVERSAL_WINDOWS_FIND_DATAW * pdata);
//
//      static bool WINAPI FindNextFile(HANDLE handle, UNIVERSAL_WINDOWS_FIND_DATAW * pdata);
//
...
//   }
//
//   inline HANDLE shell::FindFirstFile(const unichar * pcsz, UNIVERSAL_WINDOWS_FIND_DATAW * pdata)
//
//   {
...
//   }
//
//   inline bool shell::FindNextFile(HANDLE handle, UNIVERSAL_WINDOWS_FIND_DATAW * pdata)
//
//   {
