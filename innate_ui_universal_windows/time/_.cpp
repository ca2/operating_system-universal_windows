...
//#if defined(_UNIVERSAL_WINDOWS_WINNT) && (_UNIVERSAL_WINDOWS_WINNT >= _UNIVERSAL_WINDOWS_WINNT_WIN7) // Windows 7 or greater
#if defined(_UNIVERSAL_WINDOWS_WINNT) && (_UNIVERSAL_WINDOWS_WINNT >= _UNIVERSAL_WINDOWS_WINNT_LONGHORN) // Windows 7 or greater
   ...
   return
   osversioninfo.dwPlatformId == VER_PLATFORM_UNIVERSAL_WINDOWSs
   || (osversioninfo.dwPlatformId == VER_PLATFORM_UNIVERSAL_WINDOWS_WINDOWS && ((osversioninfo.dwMajorVersion == 4 && osversioninfo.dwMinorVersion <= 10) || osversioninfo.dwMajorVersion < 4));
...
#if defined(_UNIVERSAL_WINDOWS_WINNT) && (_UNIVERSAL_WINDOWS_WINNT >= _UNIVERSAL_WINDOWS_WINNT_WINXP) // winxp or greater
...
int_bool is_windows_8_or_greater()
{
   ...
   return osversioninfo.dwPlatformId == VER_PLATFORM_UNIVERSAL_WINDOWS_NT && osversioninfo.dwMajorVersion >= 6 && osversioninfo.dwMinorVersion >= 2;
...
//      return 0;
//
//   return osversioninfo.dwPlatformId == VER_PLATFORM_UNIVERSAL_WINDOWS_NT && osversioninfo.dwMajorVersion >= 6;
//
//#endif
//
//}
...
//      return 0;
//
//   return osversioninfo.dwPlatformId == VER_PLATFORM_UNIVERSAL_WINDOWS_NT && (osversioninfo.dwMajorVersion > 5 || (osversioninfo.dwMajorVersion == 5 && osversioninfo.dwMinorVersion >= 1);
//
//#endif
//
//}
...
//      return 0;
//
//   return osversioninfo.dwPlatformId == VER_PLATFORM_UNIVERSAL_WINDOWS_NT && osversioninfo.dwMajorVersion >= 5;
//
//#endif
//
//}
...
//    auto pmessagebox = øallocate windows::message_box();
