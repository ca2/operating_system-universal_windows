...
namespace innate_ui_universal_windows
{
   ...
   //const WCHAR * g_pszWindowClass = L"innate_ui_universal_windows_window";
...
//
   ...
   ::innate_ui_universal_windows::innate_ui * window::innate_ui()
   {

      return dynamic_cast <::innate_ui_universal_windows::innate_ui *> (::innate_ui::window::innate_ui());
