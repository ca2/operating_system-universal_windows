...
namespace innate_ui_universal_windows
{
   ...
   void innate_ui::on_initialize_particle()
   {
      ...
      _defer_run_innate_ui_universal_windows_user_loop();
   ...
   void innate_ui::_defer_run_innate_ui_universal_windows_user_loop()
   {
   ...
   //   ::pointer <::innate_ui_universal_windows::innate_ui> pinnateui = system()->innate_ui();
