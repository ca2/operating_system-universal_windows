...
#if defined(_innate_ui_universal_windows_project)
#define CLASS_DECL_INNATE_UI_UNIVERSAL_WINDOWS  CLASS_DECL_EXPORT
#else
#define CLASS_DECL_INNATE_UI_UNIVERSAL_WINDOWS  CLASS_DECL_IMPORT
#endif
