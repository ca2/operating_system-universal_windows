...
#if defined(_acme_windowing_universal_windows_project)
#define CLASS_DECL_ACME_WINDOWING_UNIVERSAL_WINDOWS  CLASS_DECL_EXPORT
#else
#define CLASS_DECL_ACME_WINDOWING_UNIVERSAL_WINDOWS  CLASS_DECL_IMPORT
#endif
