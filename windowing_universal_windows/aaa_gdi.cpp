...
namespace windowing_win32
{
   ...
   CLASS_DECL_WINDOWING_UNIVERSAL_WINDOWS HBITMAP create_alpha_bitmap_v5(const ::image::image * pimage)
   {
   ...
   CLASS_DECL_WINDOWING_UNIVERSAL_WINDOWS float os_get_dpi()
   {
   ...
   HICON windowing::_load_icon(string_array_base & straMatter, string strIcon, int cx, int cy)
   {
   ...
   CLASS_DECL_WINDOWING_UNIVERSAL_WINDOWS HBITMAP create_windows_dib(const ::int_size & size, int * piScan, ::color32_t ** ppdata)
   {
