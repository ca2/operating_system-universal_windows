...
namespace draw2d_gdiplus
{
   ...
   public:
      ...
      virtual bool internal_add_draw_text(::draw2d::graphics * pgraphics, const ::i32_rectangle & rectangle, const ::string & strText, ::write_text::font * pfont, const ::e_align & ealign, const ::e_draw_text & edrawtext);
