...
//      m_window = None;
   ...
   void window::assert_valid() const
   {
      ...
      //::windowing_universal_windows::window::assert_valid();
   ...
   ::e_status window::create_window(::user::interaction_impl * pimpl)
   {
      ...
      //->initialize(m_psystem->m_papplicationStartup);
...
//         default_message_handler(pmessage);
   ...
   ::e_status window::on_initialize_object()
   {
      ...
      //   m_psystem->m_pnode->call_member(SOUL_ID);
   ...
   void window::framework_view::SetWindow(::winrt::Windows::UI::Core::CoreWindow const & window)
   {
...
//      m_strText = text;
   ...
   void window::CoreWindow_WindowActivated(::winrt::Windows::UI::Core::CoreWindow sender, ::winrt::Windows::UI::Core::WindowActivatedEventArgs args)
   {
      ...
      if (args.WindowActivationState() == ::winrt::Windows::UI::Core::CoreWindowActivationState::Deactivated)
      {
         ...
         //auto puserinteraction = Sess(m_psystem).host();
 ...
 /*     void window::install_directx_application_message_routing()
      ...
      void window::framework_view::Load(winrt::param::hstring entryPoint)
      {
      ...
      void window::framework_view::Uninitialize()
      {
